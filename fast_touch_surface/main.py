...
from scripts.mouse_controller import MouseController
...
if __name__ == "__main__" :
    ...
    pose_calculator_to_mouse_controller = Queue()
    ...
    pose_calculator = Posecalculator(
        ...
        pose_calculator_to_mouse_controller = pose_calculator_to_mouse_controller,
        image_hiegh = 1280,
        image_width = 720
    )

    bluetooth_reciever = BluetoothReciever(
        bluetooth_reciever_to_data_bridge
    )
